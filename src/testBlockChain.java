...
public class TestBlockChain {
	...
	/*
	 * Quiero testear cuanto toma realizar operaciones cuando la 
	 * cantidad de ceros es alta.
	 * En este caso probaremos con 5 ceros y un tiempo mmaximo de 10 segundos
	 * para realizar 4 operaciones.
	 */
	@Test(timeout = 10000)
	...
	/*
	public void testLookUp() throws NoSuchAlgorithmException{
		chain = new BlockChain<Integer>(3,cmp);
		chain.add("add", 5);
		chain.add("remove", 5);
		chain.add("add", 4);
		chain.lookUp("lookUp", 5);
	}
	
	@Test
	public void testModify() throws NoSuchAlgorithmException{
		chain = new BlockChain<Integer>(3,cmp);
		chain.add("add", 5);
		chain.add("remove", 5);
		chain.add("add", 4);
		chain.modify("modify");
		assertEquals(false, chain.validate());
	}
	*/
